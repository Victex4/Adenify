  ...
  return (
    ...
    <div className='flex gap-[30px]'>
       <div className='bg-[#FFEFEB] text-center px-[20px] py-[20px]'>
            <img className='w-[35%] mx-auto' src="/anisha.png" alt="" />
       ...
       <div className='bg-[#FFEFEB] text-center px-[20px] py-[20px]'>
            <img className='w-[35%] mx-auto' src="/ali.png" alt="" />
       ...
       <div className='bg-[#FFEFEB] text-center px-[20px] py-[20px]'>
            <img className='w-[35%] mx-auto' src="/richard.png" alt="" />
      ...
      <div className='bg-[#FFEFEB] text-center px-[20px] py-[20px]'>
            <img className='w-[35%] mx-auto' src="/shanai.png" alt="" />
